...
/**
 * Model class supporting a list of Veranstaltung items
 *
 * @since 1.0.0
 */
class VeranstaltungenModel extends ListModel
{
	/**
	 * Constructor
	 *
	...
	/**
	 * Build an SQL query to load the list of Veranstaltung items.
	 *
	 ...
	 * Override to check only for Veranstaltungen articles, not all content.
	 *
	 * @return QueryInterface
	 *
	 * @since 1.0.0
