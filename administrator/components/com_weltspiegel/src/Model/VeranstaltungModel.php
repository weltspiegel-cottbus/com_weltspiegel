...
/**
 * Item Model for a Veranstaltung item.
 *
 * @since  1.0.0
 */
class VeranstaltungModel extends AdminModel
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_weltspiegel.veranstaltung',
			'veranstaltung', ['control' => 'jform', 'load_data' => $loadData]);
	...
	protected function loadFormData(): false|array|stdClass
	{
		...
		$data = $app->getUserState('com_weltspiegel.edit.veranstaltung.data', []);
	...
	public function save($data)
	{
		...
		$data['catid'] = 9; // Veranstaltungen category
