...
use Weltspiegel\Component\Weltspiegel\Administrator\View\Vorschauen\HtmlView;
...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_weltspiegel&task=vorschauen.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
	HTMLHelper::_('draggablelist.draggable');
}

?>
<form action="<?= Route::_('index.php?option=com_weltspiegel&view=vorschauen') ?>" method="post" name="adminForm"
      id="adminForm">
        ...
        <table class="table">
            ...
            <?php foreach ($this->items as $i => $item) : ?>
                <tr data-draggable-group="1">
                    ...
                    <td>
                        <?= HTMLHelper::_('jgrid.published', $item->state, $i, 'vorschauen.', true) ?>
                    </td>
                    <td>
                        <a href="<?= Route::_("index.php?option=com_weltspiegel&task=vorschau.edit&id=" . $item->id) ?>"
